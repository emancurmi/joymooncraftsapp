            ...
            <Row>
              <Col xl={{ size: 8, offset: 2 }}>
                <p className="lead text-muted">
                  ...
                  components that come with this theme. Theme uses ReactStrap
                  plugin which extends Bootstrap framework and makes using
                  Bootstrap in React easy.{" "}
                </p>
                <p className="lead text-muted">
                  This theme uses ReactStrap plugin which extends Bootstrap
